...
> ⚠️ **Scope of use** — Network listening, and especially emitting packets with a
> spoofed source IP (`-spoof`, which requires root), must only be done on a
> network you are responsible for, in a defensive and authorized context.
